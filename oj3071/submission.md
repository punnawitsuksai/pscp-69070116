...
```text
โจทย์ให้นับจำนวนตัวเลขที่อยู่ระหว่างA,Bที่หารdเหลือเศษrทั้งหมด

Input : ค่าA,B,d,r
Output : จำนวนเลขที่อยู่ระหว่างA,Bที่หารdเหลือเศษrทั้งหมด
Constraints : ระหว่างAถึงBคือให้รวมช่วงA,Bด้วย
```
...
```text
Step 1 : รับค่าตัวแปรA,B,d,rเป็นจำนวนเต็ม
Step 2 : สร้างตัวแปร count มีค่าเป็น 0
Step 3 : สร้างเงื่อนไขเช็ค num_A % num_d == num_r: แล้วเพิ่มค่าcountเพื่อนับจำนวน
Step 4 : แสดงผล count
```
...
```text
สร้างตัวแปร check_a ให้เท่ากับ num_A เพื่อให้เป็นตัวตรวจสอบค่า แทนการใช้ num_A
```
...
```text
ช่วยแนะแนวทางให้สร้างตัวแปรเพิ่มเพื่อเป็นตัวcheckค่า แทนการนำค่าช่วงมาใช้ เนื่องจากinputเป็นค่าเดิมตลอด
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำความเข้าใจวิธีทำ และปรับแก้โค้ด
```
