...
```text
โจทย์ให้รับค่าหมายเลขห้องที่อยู่และให้หาว่าจะต้องทำลายกำแพงไปกี่ห้องจนกว่าจะถึงห้องหมายเลข1 โดยปราสาทจะเป็นห้องสามเหลี่ยมซ้อนลงไปเรื่อยๆ 

Input : หมายเลขห้องเริ่มต้น
Output : จำนวนกำแพงที่ต้องทำลายเพื่อให้ไปถึงห้องหมายเลข1
Constraints : หมายเลขห้องเริ่มต้นเป็น1คือไม่จำเป็นต้องทำลายกำแพงใดๆ
```
...
```text
Step 1: ลองต่อห้องปราสาทเพิ่มแล้วลองจับpatternของoutput
Step 2: คิดเงื่อนไขในการแสดงผล
```
...
```text
รับค่าหมายเลขห้อง หาว่าอยู่ชั้นที่เท่าไหร่จากด้านบนสุด ถ้าชั้นเป็นเลขคู่ หมายเลขห้องเป็นเลขคู่ จำนวนกำแพงที่ต้องทำลายจะมากกว่าห้องเลขคี่อยู่1 แต่ถ้าชั้นเป็นเลขคี่ หมายเลขห้องเป็นเลขคู่ จำนวนกำแพงที่ต้องทำลายจะน้อยกว่าห้องเลขคี่อยู่1 แล้วแสดงผลตามเงื่อนไข
```
...
```text
ชั้นเลขคี่ห้องเลขคี่ ค่าต้องมากกว่าห้องเลขคู่ ตามรูปแบบชั้นที่7 ห้องหมายเลข45=ทำลายกำแพง12,46=11,47=12,48=11,49=12 ชั้นที่8 ห้องหมายเลข50=ทำลายกำแพง14,51=13,52=14,53=13
```
...
```text
หมายเลขห้องเยอะป้องกันการดักcase
```
