...
```text
โจทย์ให้เขียนโปรแกรมสลับตัวอักษรจากหลังมาหน้า

input : รับข้อความตัวอักษรที่ผู้ใช้กรอก
output : แสดงข้อความที่สลับตัวอักษรแล้ว
constraints : รับค่าไม่เกิน5ตัวอักษร outputตัวพิมพ์เล็กทั้งหมด
```
...
```text
Step 1: รับค่าตัวอักษรเป็นstringในตัวแปรname
Step 2: สลับตำแหน่งตัวอักษรโดยใช้[start:stop:step]เริ่มจากตัวท้ายสุดแล้วย้อนมาถึงตัวแรกสุดแล้วเก็บค่าตัวอักษรที่สลับแล้วใส่ตัวแปร output_name
Step 3: แสดงข้อความในตัวแปร output_name ในรูปแบบตัวพิมพ์เล็กโดยใช้ output_name.lower()

ตอนแรกไม่รู้ว่าจะแปลงเป็นตัวพิมพ์เล็กยังไง เลยค้นหาในgoogleเลยรู้ว่าให้ใช้ text.lower()
```
...
```text
มีตัวพิมพ์ใหญ่หลายตัว ยาวเกิน5อักษร
```
