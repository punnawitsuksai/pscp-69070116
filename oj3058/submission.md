...
```text
โจทย์ให้หาว่าจะใช้อิฐก้อนเล็กน้อยที่สุดเท่าไหร่ในการสร้างสะพานยาวgoalหน่วย โดยอิฐก้อนเล็ก ยาว1หน่วย อิฐก้อนใหญ่ ยาว5หน่วย

Input : จำนวนอิฐก้อนเล็ก(a), จำนวนอิฐก้อนใหญ่(b), ความยาวสะพาน
Output : จำนวนอิฐก้อนเล็กที่น้อยที่สุด
Constraints : ถ้ามีจำนวนอิฐไม่พอในการสร้างสะพานหรือจำนวนอิฐก้อนเล็กไม่พอดีให้แสดงค่า"-1"
```
...
```text
Step 1: รับค่าa,b,goal
Step 2: ตรวจสอบว่ามีจำนวนอิฐเพียงพอในการสร้างสะพานไหม
Step 3: วนลูปใช้อิฐก้อนใหญ่ไปเรื่อยๆจนgoal<ความยาวอิฐก้อนใหญ่
Step 4: แสดงผลอิฐก้อนเล็กที่เหลือ
```
...
```text
รับค่าa,b,goal ตรวจสอบว่ามีจำนวนอิฐเพียงพอในการสร้างสะพานไหม แล้วตรวจว่าgoal>=ความยาวอิฐก้อนใหญ่ที่มีทั้งหมดต่อกันไหม ถ้ามันมากกว่าแสดงว่าต้องใช้อิฐก้อนใหญ่ทั้งหมดแล้วใช้อิฐก้อนเล็กโปะให้พอดี ไม่เช่นนั้นก็เช็คเศษจากอิฐก้อนใหญ่แล้วตรวจว่ามีอิฐก้อนเล็กพอไหมแล้วแสดงจำนวนอิฐก้อนเล็กที่ใช้
```
...
```text
สามารถใช้แค่อิฐก้อนใหญ่อย่างเดียวได้
```
...
```text
ต้องใช้อิฐก้อนใหญ่ให้หมดแล้วโปะด้วยอิฐก้อนเล็ก
```
...
```text
ถ้าใช้อิฐก้อนใหญ่ทั้งหมด80ก้อน จะยาว400หน่วย ซึ่งเกินเป้าหมายที่399หน่วย แต่ถ้าใช้อิฐก้อนใหญ่79ก้อน จะยาว395หน่วย ซึ่งถ้ารวมกับจำนวนอิฐก้อนเล็กที่มีทั้งหมด3ก้อน จะสร้างได้398หน่วย ซึ่งไม่พอดีกับ399หน่วย จึงต้องแสดงค่า"-1"
```
