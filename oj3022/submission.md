...
```text
โจทย์ให้เขียนโปรแกรมแปลงค่าเปลี่ยนหน่วยอุณหภูมิ

input : ตัวเลขค่าอุณหภูมิ, หน่วยอุณหภูมิเริ่มต้น, หน่วยอุณหภูมิเป้าหมาย
output : ค่าอุณหภูมิที่เปลี่ยนหน่วยแล้ว ทศนิยม2ตำแหน่ง
constraints : ค่าอุณหภูมิเป็นจำนวนจริง, หน่วยเป็นstringมีได้แค่C,F,K,R , ถ้าหน่วยอุณหภูมิเริ่มต้น=หน่วยอุณหภูมิเป้าหมายควรจะได้ค่าเดิม
```
...
```text
Step 1 : รับค่าinputเป็นค่าอุณหภูมิ, หน่วย, หน่วยเป้าหมาย
Step 2 : สร้างเงื่อนไขเช็คหน่วยและหน่วยเป้าหมายแยกให้ครบทุกกรณี
Step 3 : คิดสูตรที่ใช้คำนวณเปลี่ยนหน่วยอุณหภูมิ
Step 4 : นำสูตรใส่ในเงื่อนไขให้ครบและแสดงผล
```
...
```text
สร้างตัวแปรที่เก็บค่าสูตรคำนวณของการแปลงหน่วยทุกกรณีไว้ให้หมดก่อนในบรรทัดด้านบน แล้วค่อยแยกกรณีที่เช็คหน่วยแล้วprintตัวแปรอย่างเดียว
```
