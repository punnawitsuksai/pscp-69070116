...
```text
โจทย์ให้นับตัวa,e,i,o,uในข้อความและแสดงผล

Input : รับข้อความ
Output : จำนวนตัวa,e,i,o,uแต่ละตัว
Constraints : ตัวพิมพ์เล็กพิมพ์ใหญ่เป็นตัวเดียวกัน,ถ้าไม่มีสระตัวนั้นก็ไม่ต้องแสดงผล
```
...
```text
Step 1 : รับค่าข้อความเป็นstr
Step 2 : สร้างเงื่อนไขตรวจสอบและนับa,e,i,o,uแยกกัน
Step 3 : เช็คว่ามีอย่างน้อย1ตัวถึงค่อยแสดงผล
```
...
```text
วิธีสุดท้ายนับโดยใช้ if c in "a",if c in "e",if c in "i",if c in "o",if c in "u"โดยใช้ for loop c in text:
```
...
```text
มีเว้นวรรค,ตัวพิมพ์ใหญ่,มีทุกสระ
```
