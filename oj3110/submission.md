...
```text
โจทย์ให้หาค่าส่งของจากที่หนึ่งไปอีกที่หนึ่งโดยขึ้นอยู่กับเกณฑ์ที่โจทย์กำหนดกับน้ำหนักของพัสดุ

Input : บรรทัดแรกรับรหัสสถานที่ต้นทาง,ปลายทาง บรรทัดที่2รับน้ำหนักพัสดุเป็นfloat
Output : ราคาค่าส่งพัสดุ
Constraints : หากไม่มีในเงื่อนไขให้แสดง"Error"
```
...
```text
Step 1 : รับค่าต้นทางปลายทาง แยกด้วย input.split
Step 2 : แยกคำนวณราคาตามเงื่อนไขโจทย์ ถ้าไม่มีในเงื่อนไขให้แสดง"Error"
Step 3 : แสดงผลราคา
```
...
```text
วิธีสุดท้ายเหมือนวิธีแรก เพราะ แผนถูกต้องแล้ว
```
