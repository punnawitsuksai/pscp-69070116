...
```text
โจทย์ให้รับค่าการกระทำ(N) แล้วloopรับค่า"+"หรือ"-"ตามจำนวนNแล้วเพิ่ม/ลดคะแนนสะสม

Input : รับค่าการกระทำ(N) ค่า"+","-"
Output : คะแนนสะสมรวมโดย"+"คือเพิ่ม10คะแนน "-"คือลดคะแนน5คะแนน
Constraints : คะแนนเริ่มต้นที่0
```
...
```text
Step 1 : รับค่าN
Step 2 : loop Nครั้ง รับค่า+,-
Step 3 : คำนวณคะแนนสะสม
Step 4 : แสดงผลคะแนนรวม
```
...
```text
วิธีสุดท้ายเหมือนแผนแรก เพราะ แสดงค่าได้ถูกต้อง
```
