...
```text
โจทย์ให้แปลงรหัสไพ่เป็นชื้อเจ็มของไพ่

Input : รหัสไพ่ประกอบด้วยแต้มและสัญลักษณ์
Output : ชื่อเต็มของไพ่
Constraints : อักษรภาษาอังกฤษสามารถรับได้ทั้งพิมพ์ใหญ่พิมพ์เล็ก
```
...
```text
Step 1 : รับรหัสไพ่
Step 2 : แยกส่วนของแต้มและสัญลักษณ์ โดยการใช้index[0]สำหรับแต้ม และ[-1]สำหรับสะัญลักษณ์
Step 3 : แสดงผลชื่อเต็ม คั่นด้วย "of"
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก แต่เปลี่ยนตรงรับค่ารหัสเป็น .upper
```
