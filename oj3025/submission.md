...
```text
โจทย์ให้เขียนโปรแกรมที่อ่านค่าเดือนและวันที่ แล้วจำแนกฤดูกาล

input : เดือนและวันที่ เป็นจำนวนเต็ม
output : ฤดูกาล 4 เงื่อนไข
constraints : เดือนต้องอยู่ใน1ถึง12
```
...
```text
Step 1 : รับค่าเดือนเป็นจำนวนเต็ม
Step 2 : รับค่าวันที่เป็นจำนวนเต็ม
Step 3 : สร้างเงื่อนไขจำแนกฤดูกาลถ้าเดือน1,2,3ให้พิมพ์"winter"4,5,6ให้พิมพ์"spring"7,8,9ให้พิมพ์"summer"10,11,12ให้พิมพ์"fall"
Step 4 : ถ้าเดือน3,6,9,12 วันที่21จะเป็นฤดูกาลถัดไป
```
...
```text
ตอนแรกให้ตรวจเดือนก่อน แล้วค่อยตรวจเดือน3,6,9,12กับวันที่เกิน21 แต่วิธีสุดท้ายให้ตรวจวันที่ก่อนเพราะมันทำเรียงลงมา
```
...
```text
เดือน6ปกติต้องเป็นspring แต่วันที่21เป็นจุดเปลี่ยนเดือน
```
