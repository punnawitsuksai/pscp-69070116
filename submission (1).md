...
```text
โจทย์ให้เขียนโปรแกรมรับค่าสีสองสีแล้วให้เอามาผสมกัน โดยแยกผลลัพธ์แต่ละเงื่อนไข

input : รับสีที่1และ2
output : แสดงสีที่ผสมกันแล้ว
constraints : สีที่1กับ2ต้องสลับกันได้ สีเดียวกันผสมกันได้สีเดิม หากผสมไม่ได้ให้แสดง"Error"
```
...
```text
Step 1 : รับค่าสี2สีเป็นstring
Step 2 : สร้างเงื่ิอนไขว่าแต่ละสีผสมกันได้อะไร และลิสมาให้หมด
Step 3 : แสดงผลสี หากผสมไม่ได้ให้แสดง"Error"
```
...
```text
ช่วยแนะให้เพิ่มเงื่อนไขสีเดียวกันผสมได้สีเดิม
```

คุณยังทำอะไรด้วยตนเอง

```text
ได้คิดเงื่อนไขเพิ่มให้สามารถสลับcolor1กับ2ได้
```
