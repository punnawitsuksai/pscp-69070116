...
```text
โจทย์ให้เขียนโปรแกรมคำนวณราคาที่ต้องจ่าย ซึ่งมีค่าอาหาร+ค่าบริการ+ภาษีvat

input : ค่าอาหาร
output : ราคารวมทั้งหทด
constraints : รับinputเป็นจำนวนเต็มเท่านั้น outputมีทศนิยม2ตำแหน่ง
```
...
```text
นำค่าอาหารคูณภาษี7%ก่อน แล้วค่อยรวมค่าบริการ แต่testcaseไม่ตรงเลยสลับขั้นตอนเป็นคูณภาษีหลังสุด
```
...
```text
คิดค่าบริการ10%ของค่าอาหาร แต่ค่าบริการต่ำสุดคือ50และสูงสุดคือ1000 เลยสร้างเงื่อนไขว่าถ้าค่าบริการที่คิดได้มีค่าน้อยกว่า50 ก็ให้เปลี่ยนกลับเป็น50 ถ้าค่าบริการเกิน1000 ก็ล็อคไว้ที่1000 ถ้าค่าบริการอยู่ในช่วงก็ใช้ค่านั้นเลย เสร็จแล้วเอาไปรวมกับค่าอาหารแล้วค่อยเอาค่าที่รวมแล้วคูณ1.07(ค่าVAT)
```
