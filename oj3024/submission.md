...
```text
โจทย์ให้เขียนโปรแกรมตรวจคะแนนโหวตว่ามีโอกาสโกงคะแนนโหวตไหม ถ้ามีโอกาสโกงให้แสดง"Surprising" ถ้าไม่มีโอกาสโกงให้แสดง"Not surprising"

input : รับค่าคะแนนรวมและคะแนนโหวตสูงสุดเป็นจำนวนจริง
output : "Surprising" หรือ "Not surprising"
constraints : คะแนนโหวตอยู่ในช่วง0-10 คะแนนรวมไม่เกิน30
```
...
```text
Step 1 : รับค่าคะแนนรวมและคะแนนสูงสุด
Step 2 : สร้างตัวแปรlowest_score เก็บค่าคะแนนต่ำสุดที่เป็นไปได้
Step 3 : ตรวจว่าคะแนนสูงสุดต่างกับคะแนนต่ำสุดเกิน2ไหม ถ้าไม่เกินพิมพ์"Not surprising" ถ้าเกินพิมพ์"Surprising"
```
...
```text
เหมือนวิธีแรก แต่ตรงการคำนวณlowest_score ต้องสร้างเงื่อนไขเพิ่มเช็คว่าถ้าคะแนนติดลบ ให้lowest_scoreมีค่า=0 เพราะคะแนนโหวตติดลบไม่ได้
```
...
```text
คะแนนต่ำสุดห่างกับคะแนนสูงสุดเกิน2
```
...
```text
lowest_score ตามสูตรคำนวณติดลบ
```
